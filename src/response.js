...
//dynamic
	...
	dynBundle() { return "BUNDLE"; }
	dynImageJpg() { return "IMAGE" };
	dynImagePng() { return "IMAGE" };
	dynlast_id() { return "NOTIFY" };
	dynNotifierServer() { return "NOTIFY" };
...
//static
	...
	clientGameProfileSelect(url, info, sessionID){
		return response_f.getBody({"status":"ok", "notifier": {"server": server.getBackendUrl() + "/", "channel_id": "testChannel", "url": "", "notifierServer" : "", "ws": ""}, "notifierServer": ""});
	}
